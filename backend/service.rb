...
module AI
    module ValidityAnalysis
      class Service
        ...
        def subject_matter
          @subject_matter ||= AI::ValidityAnalysis::SubjectMatter.new(
            llm_subject_matter: agent_response[:subject_matter]
          )
        end
  
        def inventive_concept
          @inventive_concept ||= AI::ValidityAnalysis::InventiveConcept.new(
            llm_inventive_concept: agent_response[:inventive_concept],
            subject_matter: subject_matter.value
          )
        end
        ...
        def overall_eligibility
          @overall_eligibility ||= AI::ValidityAnalysis::OverallEligibility.new(
            subject_matter: subject_matter.value,
            inventive_concept: inventive_concept.value
          )
        end
        ...
        def update_ai_validity_analysis_detail_with_success!
          ai_validity_analysis_detail.update!(
            ...
            status_message: nil,
            subject_matter: subject_matter.value,
            inventive_concept: inventive_concept.forced_value,
