...
module AI
    module ValidityAnalysis
      class OverallEligibility
        OVERALL_ELIGIBILITY_ERROR_MESSAGE = 'Subject matter was identified as %<subject_matter>s ' \
                                            'but cannot determine inventive concept'
  
        INCORRECT_DATA_ERROR_MESSAGE = 'LLM respond with incorrect data. Subject matter: %<subject_matter>s, ' \
                                       'inventive concept: %<inventive_concept>s'
        ...
        attr_reader :subject_matter, :inventive_concept
      end
    end
  end